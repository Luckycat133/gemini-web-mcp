...
For skill-only changes, at minimum run the skill validator:

```bash
./.venv/bin/python /Users/jack/.codex/skills/.system/skill-creator/scripts/quick_validate.py .codex/skills/gemini-web-mcp
```
