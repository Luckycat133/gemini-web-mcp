...
- Documented the current Codex, Claude Desktop, and VS Code protocol paths and set project support for the SDK v1-compatible `v1.3.x` line to end on **2027-01-31**
