...
The unified ClawHub release line is `0.2.0`, including the security-audit wording and disclosure contract. To install directly from the repository instead:
