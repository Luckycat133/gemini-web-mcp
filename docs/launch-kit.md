...
I just released Gemini Web MCP v1.3.0.
...
I released Gemini Web MCP v1.3.0, an MCP server and Codex skill for using Gemini Web from AI coding agents.
...
GEMINI_TOOLS=model uvx --from https://github.com/Luckycat133/gemini-web-mcp/releases/download/v1.3.0/gemini_mcp_server-1.3.0-py3-none-any.whl gemini-mcp-server
